  ...
  class SHA512 {
    ...
    protected:
      static const uint32_t SHA512_BLOCK_BIT_SIZE = 1024;
      static const uint32_t SHA512_CHUNK_BIT_SIZE =   64;
    ...
    private:
      ...
      uint64_t rightrotate(uint64_t x, uint64_t n);
      uint64_t leftrotate (uint64_t x, uint64_t n);
      uint64_t rightshift (uint64_t x, uint64_t n);
      uint64_t E0         (uint64_t x);
      uint64_t E1         (uint64_t x);
      uint64_t D0         (uint64_t x);
      uint64_t D1         (uint64_t x);
